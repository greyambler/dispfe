 ...
 */}                        </tbody>
                ...
                {/* 
                    {this.state.isPL_View &&
                        <table>
                            <tbody>
                                <tr>
                                    <td key={createGuid()} style={style_td}>
                                        <W_prop_value el="TOTAL_OBSERVED_VOLUME"
                                            prop_value="Объем общий"
                                        />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td key={createGuid()} style={style_td}>
                                        <W_prop_value el="AVERAGE_TEMP"
                                            prop_value="Температура" />
                                    </td>
                                </tr>
                                <tr>
                                    <td key={createGuid()} style={style_td}>
                                        <W_prop_value el="TP_STATUS"
                                            prop_value="Статус" />
                                ...
                                <tr>
                                    <td key={createGuid()} style={style_td} >
                                        <W_prop_value el="cn08"
                                            prop_value="Масса" />
                                    </td>
                                </tr>
                                <tr>
                                    <td key={createGuid()} style={style_td} >
                                        <W_prop_value el="OBSERVED_DENSITY"
                                            prop_value="Плотность (кг/м3)" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td key={createGuid()} style={style_td}>
                                        <W_prop_value el="TOTAL_GROSS_STANDARD_VOLUME"
                                            prop_value="Объем продукта (л)" />
                                    </td>
                                </tr>

                                <tr>
                                    <td key={createGuid()} style={style_td}>
                                        <W_prop_value el="water_level"
                                            prop_value="Вода Уровень(мм)" />
                                    </td>
                                </tr>

                                <tr>
                                    <td key={createGuid()} style={style_td} >
                                        <W_prop_value el="PRODUCT_LEVEL"
                                            prop_value="Уровень (мм)" />
                                    </td>
                                </tr>
                                <tr>
                                    <td key={createGuid()} style={style_td} >
                                        <W_prop_value el="WATER_VOLUME"
                                            prop_value="Вода Объем (л)" />
                                    </td>
                                </tr>
                                <tr>
                                    <td key={createGuid()} style={style_td} >
                                        <W_prop_value el="state_pl"
                                            prop_value="Статус блокировки" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
