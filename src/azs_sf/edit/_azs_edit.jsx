...
export default class _azs_edit extends Component {
   constructor(props) {
      super(props);
      ...
      this.state = {
         ...
         iid: this.props.Data.iid,
         dispname: this.props.Data.dispname,
         th_code: this.props.Data.th_code,
         order_num: this.props.Data.order_num,
         shortname: this.props.Data.shortname,
         region_code: this.props.Data.region_code,
         region_name: this.props.Data.region_name,
