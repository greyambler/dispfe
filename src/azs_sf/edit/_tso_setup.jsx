...
import {
    ...
    Get_Main_PROPS, RSS_List_Main, RSS_AZS, createGuid, Init_DVC, WhatKeyNotShow, get_Line_PL, get_Line_TSO
} from '../../core/core_Function.jsx';

import C_tso_edit from './_tso_edit.jsx';
...
export default class _tso_setup extends Component {
    constructor(props) {
        super(props);
            ...
            return (
                <div style={style_td}>
                                            ...
                                            <tbody>
                                                <tr key={createGuid()}>
                                                    ...
                                                    <td key={createGuid()} style={style_td}>
                                                        {get_Line_TSO(this.state.curentPL)}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                    ...
                    <Modal id="ModalTable" size={size1} open={this.state.open_PL} onClose={this.close_Modal_PL} closeIcon >
                        <center><Modal.Header>ТСО</Modal.Header></center>
                        <Container>
                            <C_tso_edit onClose={this.close_Modal_PL} main_Creat={this.main_Creat_PL}
