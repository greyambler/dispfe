...
export default class azs_list_main extends React.Component {
    constructor(props) {
        ...
        this.List_AZS_Click = this.List_AZS_Click.bind(this);
        this.List_DVC_Click = this.List_DVC_Click.bind(this);
        ...
        this.state = {
            ...
            _up_ListDVC: false,
            _arrow_ListDVC: "images/arrow_Down.png",
                                    ...
                                    <div>
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td width="30">
                                                        <Image src={this.state._arrow_ListAZS} onClick={this.List_AZS_Click} />
                                                    </td>
                                                    <td id='td_button'>
                                        ...
                                        <div>
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td width="30">
                                                            <Image src={this.state._arrow_ListDVC} onClick={this.List_DVC_Click} />
                                                        </td>
                                                        <td >{get_Line_AZS(this.state.curentAZS)}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
